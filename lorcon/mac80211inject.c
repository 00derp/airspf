...
int tx80211_mac80211_init(struct tx80211 *in_tx)
{
	in_tx->capabilities = tx80211_mac80211_capabilities();
	...
	in_tx->txpacket_callthrough = &tx80211_mac80211_send;
...
int tx80211_mac80211_send(struct tx80211 *in_tx, struct tx80211_packet *in_pkt)
{
	...
	rtaphdr->wr_tx_flags = 0x18; /* FIXME no magic numbers! */
